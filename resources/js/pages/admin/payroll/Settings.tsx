...
import { Settings as SettingsIcon, Pencil, Plus, Trash2, Clock } from 'lucide-react';
                    ...
                    <Dialog open={open} onOpenChange={setOpen}>
                        <DialogTrigger asChild>
                            <Button onClick={openCreate} className="bg-[oklch(0.48_0.032_195.5)] text-white hover:bg-[oklch(0.38_0.032_195.5)]">
                                <Plus className="mr-2 size-4" />Pengaturan THR
                            </Button>
                        </DialogTrigger>
                                    ...
                                    <tr>
                                        <td colSpan={5} className="py-12 text-center text-sm italic text-slate-500">
                                            <div className="flex flex-col items-center px-6 py-12 text-center">
                                                ...
                                                <h2 className="font-serif text-xl font-bold" style={{ color: INK }}>Belum Ada THR</h2>
