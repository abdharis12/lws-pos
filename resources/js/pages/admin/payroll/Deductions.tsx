...
interface Props { deductions: DeductionData[]; employees: EmployeeData[]; }
...
export default function Deductions({ deductions, employees }: Props) {
    ...
    const [deleteConfirm, setDeleteConfirm] = useState<DeductionData | null>(null);
                                    ...
                                    <tr>
                                        <td colSpan={6} className="py-12 text-center text-sm italic text-slate-500">
                                            <div className="flex flex-col items-center px-6 py-12 text-center">
                                                ...
                                                <h2 className="font-serif text-xl font-bold" style={{ color: INK }}>Belum Ada Potongan</h2>
                                                <p className="mt-1 max-w-sm text-sm" style={{ color: 'oklch(0.60 0.03 88.5)' }}>
                                                    Belum ada potongan. Klik "Tambah Potongan" untuk menambahkan.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <DialogContent className="border-[oklch(0.80_0.038_88.5)]/40 bg-[oklch(0.98_0.005_85.0)] sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-center text-slate-500">
                                Apakah Anda yakin ingin menghapus potongan untuk <span className="font-semibold text-[oklch(0.48_0.032_195.5)]">{deleteConfirm?.employee.user.name}</span> pada periode <span className="font-semibold text-[oklch(0.48_0.032_195.5)]">{deleteConfirm?.period}</span>? Tindakan ini tidak dapat dibatalkan.
                            </DialogDescription>
                        </DialogHeader>
