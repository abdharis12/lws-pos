...
export default function OptionGroupsIndex({ groups, filters }: Props) {
    ...
    const [deleteConfirm, setDeleteConfirm] = useState<OptionGroup | null>(
        null,
    );
                ...
                <div className="mb-8 flex flex-col justify-between gap-4 border-b border-[#CFC0A4]/40 pb-6 sm:flex-row sm:items-end">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500 italic">
                            Kelola opsi tambahan untuk varian menu restoran
                            Anda.
                        </p>
                    </div>
                    ...
                    <Dialog open={open} onOpenChange={setOpen}>
                        ...
                        <DialogContent className="max-w-xl border-[#CFC0A4]/40 bg-[#F6F2E9]">
                            <DialogHeader>
                            ...
                            <form onSubmit={submit} className="space-y-4">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="selection_type">
                                        Tipe Seleksi
                                    </Label>
                                    <Select
                                        value={data.selection_type}
                                        onValueChange={(v) =>
                                            setData('selection_type', v)
                                        }
                                    >
                                ...
                                <div className="grid gap-2">
                                    ...
                                    {data.items.map((item, i) => (
                                        <div
                                            key={i}
                                            className="flex items-end gap-2 rounded-md border border-[#CFC0A4]/30 bg-white/60 p-2"
                                        >
                        ...
                        >
                            ...
                            <CardHeader className="pt-4 pb-2">
                                <div className="flex items-start justify-between gap-2">
                                    <div>
                                        <span className="text-[10px] font-semibold tracking-[0.15em] text-[#CFC0A4] uppercase">
                                ...
                                {group.option_items.length === 0 ? (
                                    ...
                                    <ul className="space-y-1">
                                        {group.option_items.map((item) => (
                                            <li
                                                key={item.id}
                                                className="flex items-center justify-between border-t border-[#CFC0A4]/10 py-1.5 text-sm"
                                            >
                        ...
                        <div className="col-span-full py-16 text-center">
                            <div className="mx-auto flex max-w-sm flex-col items-center justify-center text-center">
                                ...
                                <h4 className="font-serif text-lg font-medium text-slate-700">
                                    Grup Opsi Tidak Ditemukan
                                </h4>
                                <p className="mt-1 text-xs text-slate-500 italic">
                                    Cobalah untuk merubah kata kunci pencarian
                                    atau tambahkan grup opsi baru.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    <DialogContent className="border-[#CFC0A4]/40 bg-[#F6F2E9] sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-center text-slate-500">
                                Apakah Anda yakin ingin menghapus grup opsi{' '}
