...
export default function KitchenHeader({ orderCount, soundEnabled, onSoundToggle, printEnabled = true, onPrintToggle }: Props) {
    ...
    return (
        <div className="sticky top-0 z-20 -mx-4 -mt-4 mb-6 px-4 pb-4 pt-4"
            style={{
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-white/40">
                        Update terakhir {now.toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' })}
                    </p>
                </div>

                <div className="ml-auto flex items-center gap-3">
                    <span className="flex items-center gap-2 rounded-full px-3 py-1.5 text-xs"
                    ...
                    >
                        ...
                        <span className="text-white/60">{orderCount} pesanan</span>
                    </span>
