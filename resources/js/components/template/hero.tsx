...
export const Hero: React.FC<HeroProps> = ({ onOpenReservation, onExploreMenu }) => {
    return (
        <section className="relative min-h-screen bg-[#4F6B6A] text-[#FAF8F5] overflow-hidden pt-20 pb-16 lg:py-24 border-b border-[#CFC0A4]/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                        ...
                        {/* Top Badge */}
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#233433] border border-[#CFC0A4]/40 text-[#CFC0A4] text-xs font-display font-medium tracking-widest uppercase shadow-inner">
                            <Sparkles className="w-3.5 h-3.5 text-[#CFC0A4]" />
                            <span>Bubur Ayam dengan cita rasa yang khas</span>
                        </div>

                        {/* Main Headline */}
                        <h1 className="font-display text-3xl sm:text-5xl xl:text-6xl font-normal leading-[1.15] text-[#FAF8F5] tracking-tight">
                            Kehangatan <span className="italic font-display text-[#CFC0A4]">Nusantara</span> dalam Kemewahan.
                        </h1>

                        {/* Subtitle */}
                        <p className="text-base sm:text-lg font-display font-light text-[#FAF8F5]/90 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                        ...
                        {/* Feature Pills */}
                        <div className="pt-2 flex flex-wrap justify-center lg:justify-start gap-3 text-xs font-display text-[#FAF8F5]/90">
                        ...
                        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                            <button
                                ...
                                className="w-full sm:w-auto px-8 py-4 rounded-md bg-[#CFC0A4] text-[#233433] font-display font-bold text-xs tracking-widest uppercase hover:bg-[#FAF8F5] transition-all duration-300 shadow-xl flex items-center justify-center gap-2 group"
                            >
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-8 py-4 rounded-md bg-[#233433] border border-[#CFC0A4] text-[#CFC0A4] font-display font-semibold text-xs tracking-widest uppercase hover:bg-[#CFC0A4] hover:text-[#233433] transition-all duration-300 flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="pt-6 border-t border-[#CFC0A4]/20 grid grid-cols-2 sm:grid-cols-3 gap-4 text-left text-xs font-display text-[#FAF8F5]/80">
                            <div>
                                <p className="text-[#CFC0A4] font-display text-sm italic">Jam Operasional</p>
                                <p className="font-medium mt-0.5">Senin - Minggu: 07:00 - 20:00</p>
                            </div>
                            <div>
                                <p className="text-[#CFC0A4] font-display text-sm italic">Suasana</p>
                                <p className="font-medium mt-0.5">Classic European & Terrace</p>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                <p className="text-[#CFC0A4] font-display text-sm italic">Lokasi Flagship</p>
                        ...
                        <div className="relative w-full max-w-md bg-[#233433] rounded-2xl p-6 border-2 border-[#CFC0A4]/40 shadow-2xl overflow-hidden group">
                            ...
                            <div className="relative h-80 rounded-lg overflow-hidden border border-[#CFC0A4]/30 shadow-inner">
                                ...
                                <div className="absolute bottom-3 left-3 right-3 flex justify-between items-center text-xs text-[#FAF8F5] bg-[#233433]/80 backdrop-blur-md px-3 py-2 rounded border border-[#CFC0A4]/20">
                                    <span className="font-display italic text-[#CFC0A4]">Est. 2024 • Palembang</span>
                                    <span className="font-display text-[11px] font-semibold text-[#FAF8F5]">LW's by Bubur Kang LW</span>
                                </div>
                            </div>

                            {/* Featured Quote Box */}
                            <div className="mt-5 p-4 rounded-lg bg-[#4F6B6A] border border-[#CFC0A4]/20 text-center">
                                <p className="font-display text-base italic text-[#CFC0A4]">
                                    "Nikmati perpaduan harmonis antara sedap gurih bubur warisan keluarga dari generasi ke generasi."
                                </p>
                                <p className="font-display text-[11px] text-[#FAF8F5]/80 mt-2 uppercase tracking-widest font-semibold">
