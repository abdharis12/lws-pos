import { Calendar, Clock, Users, MapPin, CheckCircle2, Sparkles, X, Phone, User, MessageSquare } from 'lucide-react';
...
export const ReservationModal: React.FC<ReservationModalProps> = ({ isOpen, onClose }) => {
    ...
    const [bookingCode] = useState(() => `LW-${Math.floor(100000 + Math.random() * 900000)}`);
    ...
    const ADMIN_WHATSAPP = '6281341591267';
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const message = [
            `Halo LW's by Bubur Kang LW, saya ingin mengonfirmasi reservasi meja.`,
            ``,
            `━━━━━━━━━━━━━━━━`,
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 font-sans-clean text-xs">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    >
                                        ...
                                        <option value="10:00">10:00 WIB (Morning Tea)</option>
                                        <option value="12:30">12:30 WIB (Lunch Time)</option>
                                        <option value="15:30">15:30 WIB (High Tea & Pudding)</option>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1">
                                    {[
                                        { id: 'Indoor Lantai 1', name: 'Indoor Lantai 1' },
                                        { id: 'Indoor Lantai 2', name: 'Indoor Lantai 2' },
                                        { id: 'Teras Garden 1', name: 'Teras Garden 1' },
                                        { id: 'Teras Garden 2', name: 'Teras Garden 2' },
                                    ].map((area) => (
                                        <button
                                            type="button"
                                            key={area.id}
                                            onClick={() => setFormData({ ...formData, seating: area.id })}
                                            className={`p-2.5 rounded-lg border text-left transition-all ${formData.seating === area.id
                    ...
                    <div className="p-8 text-center space-y-6 animate-fadeIn">
                        ...
                        <div className="space-y-2">
                            ...
                            <h3 className="font-serif-display text-2xl font-bold text-[#FAF8F5]">
                                Sampai Jumpa di LW's by Bubur Kang LW
                            </h3>
